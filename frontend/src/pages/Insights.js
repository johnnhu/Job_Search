    ...
    return (
        <Layout>
            ...
            <Container>
                        ...
                        <Form.Group controlId="salary">
                            <RangeSlider
                                ...
                                onChange={(changeEvent) =>
                                    setSalary(changeEvent.target.value)
                                }
                            />
                        </Form.Group>
                    </Col>
                ...
                <Row>
                    <Col xs={2}>
                        Projection: select a certain column from the applicants
                        table
                    </Col>
                    <Formik
                ...
                <Row>
                    <Col
                        xs={2}
                    >{`Aggregation: number of applicants who graduated in earliest year`}</Col>
                    <Col xs={2}>
                        <Button
                            onClick={() => {
